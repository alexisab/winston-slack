...
function (_Transport) {
  ...
  function SlackTransport() {
    ...
    _this.author_name = otps.author_name || "slack webhook";
    _this.formatter = opts.formatter || _this._formater;
    ...
    _this.log = _this.log.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this._formatter = _this._formatter.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this._getLevelText = _this._getLevelText.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this._getLevelColor = _this._getLevelColor.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
